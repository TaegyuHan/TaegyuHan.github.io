...
last_modified_at: 2026-03-10T00:00:00+09:00
---
...
다음 배열을 오름차순으로 정렬하는 과정을 살펴보겠습니다: `[5, 3, 8, 4, 2]`

### 1회차 순회
```
[5, 3, 8, 4, 2]  // 시작
[3, 5, 8, 4, 2]  // 5와 3 비교 → 교환
[3, 5, 8, 4, 2]  // 5와 8 비교 → 유지
[3, 5, 4, 8, 2]  // 8과 4 비교 → 교환
[3, 5, 4, 2, 8]  // 8과 2 비교 → 교환 (8이 맨 뒤로!)
```

### 2회차 순회
```
[3, 5, 4, 2, 8]  // 시작 (8은 정렬 완료)
[3, 5, 4, 2, 8]  // 3과 5 비교 → 유지
[3, 4, 5, 2, 8]  // 5와 4 비교 → 교환
[3, 4, 2, 5, 8]  // 5와 2 비교 → 교환 (5가 제자리로!)
```

### 3회차 순회
```
[3, 4, 2, 5, 8]  // 시작 (5, 8 정렬 완료)
[3, 4, 2, 5, 8]  // 3과 4 비교 → 유지
[3, 2, 4, 5, 8]  // 4와 2 비교 → 교환
```

### 4회차 순회
```
[3, 2, 4, 5, 8]  // 시작 (4, 5, 8 정렬 완료)
[2, 3, 4, 5, 8]  // 3과 2 비교 → 교환 (정렬 완료!)
```
